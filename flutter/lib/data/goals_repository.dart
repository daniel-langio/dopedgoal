...
class GoalsRepository extends ChangeNotifier {
  ...
  /// True once the persisted state (if any) has been read and applied. The
  /// UI can ignore this — seed data renders immediately either way — but
  /// tests may want to await it.
  ...
  Future<void> _load() async {
    try {
      ...
      // Corrupt or unreadable state: keep the seed data rather than crash.
    } finally {
      _loaded = true;
      notifyListeners();
    }
